...
import KeyValueForm from "./key_value_form";
import {useEffect, useState} from "react";
import {KeyList} from "../../api/keyAPI";
import Cookies from 'js-cookie';
import Swal from 'sweetalert2';

const KeyManagement = ({setCurrentView}) => {
    ...
    return (
        <div>
            <KeyValueForm keyListArr={keyListArr} changeFlag={changeFlag} setCurrentView={setCurrentView}></KeyValueForm>
        </div>
    );
};
